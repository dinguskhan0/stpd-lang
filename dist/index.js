...
exports.evaluate = exports.parse = exports.CommandCode = void 0;
const process_1 = require("process");
var CommandCode;
(function (CommandCode) {
    CommandCode[CommandCode["EXIT"] = 0] = "EXIT";
    CommandCode[CommandCode["SET_PTR_TO_INPUT"] = 10] = "SET_PTR_TO_INPUT";
    CommandCode[CommandCode["ADD_INPUT_TO_PTR"] = 11] = "ADD_INPUT_TO_PTR";
    CommandCode[CommandCode["MOVE_PTR"] = 12] = "MOVE_PTR";
    CommandCode[CommandCode["SET_INPUT_TO_PTR"] = 13] = "SET_INPUT_TO_PTR";
    CommandCode[CommandCode["PTR_RANDI"] = 14] = "PTR_RANDI";
    CommandCode[CommandCode["ADD_SHIFTED_TO_PTR"] = 15] = "ADD_SHIFTED_TO_PTR";
    CommandCode[CommandCode["FLIP_PTR_SIGN"] = 16] = "FLIP_PTR_SIGN";
    CommandCode[CommandCode["SET_PTR_TO_INDEX"] = 20] = "SET_PTR_TO_INDEX";
    CommandCode[CommandCode["SET_INDEX_TO_PTR"] = 21] = "SET_INDEX_TO_PTR";
    CommandCode[CommandCode["SKIP_IF_EQUAL"] = 22] = "SKIP_IF_EQUAL";
    CommandCode[CommandCode["SKIP_INPUT_TIMES"] = 23] = "SKIP_INPUT_TIMES";
    CommandCode[CommandCode["SKIP_IF_NEGATIVE"] = 24] = "SKIP_IF_NEGATIVE";
    CommandCode[CommandCode["PRINT_CHARACTER"] = 30] = "PRINT_CHARACTER";
    CommandCode[CommandCode["PRINT_NUMBER"] = 31] = "PRINT_NUMBER";
    CommandCode[CommandCode["GET_CHAR"] = 32] = "GET_CHAR";
...
exports.parse = parse;
async function evaluate(instructions) {
    const stack = { 0: 0 };
    let ptr_index = 0;
    let input = 0;
    let skips = 0;
        ...
        if (instruction.type === 'execute') {
            ...
            switch (instruction.value) {
                ...
                case CommandCode.SKIP_IF_NEGATIVE:
                    if ((stack[ptr_index] || 0) < 0)
                        skips = 1;
                    break;
                case CommandCode.PRINT_CHARACTER:
                    process_1.stdout.write(String.fromCodePoint(stack[ptr_index] || 0));
                    break;
                case CommandCode.PRINT_NUMBER:
                    process_1.stdout.write(String(stack[ptr_index] || 0));
                    break;
